...
public class BookAppoitmentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dateButton = findViewById(R.id.buttonBMCartDates);
        timeButton = findViewById(R.id.buttonCartTime);
        btnBook = findViewById(R.id.buttonBMBBook);
        btnBack = findViewById(R.id.buttonBookAppoinment2);
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(BookAppoitmentActivity.this,FindDoctorActivity.class));
        ...
        btnBook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (db.checkAppointmentExists(username,title + " => "+
                        fullname,address,contact,dateButton.getText().toString(),timeButton.getText().toString())==1){
                    Toast.makeText(getApplicationContext()  , "Appointment already booked", Toast.LENGTH_LONG).show();
                }else {
                    db.addOrder(username,title+"=>"+fullname,address,contact,
                            0,dateButton.getText().toString(),
                    ...
                    startActivity(new Intent(BookAppoitmentActivity.this, HomeActivity.class));
                }
