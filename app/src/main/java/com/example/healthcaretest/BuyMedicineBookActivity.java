...
public class BuyMedicineBookActivity extends AppCompatActivity {
    EditText edname,edaddress,edcontack,edpincode;
    Button btnBooking;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edcontack = findViewById(R.id.editTextBMBContacts);
        ...
        btnBooking.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                db.addOrder(username,edname.getText().toString(),edaddress.getText().toString(),edcontack.getText().toString(),
